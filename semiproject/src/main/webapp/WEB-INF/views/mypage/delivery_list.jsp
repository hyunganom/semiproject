<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<jsp:param value="배송 현황" name="title"/>
	</jsp:include>
...
<body>
    ...
    <div class="container-750">
        ...
        <div class="row float-container">
            <div class="float-left w-20">선택</div>
            <div class="float-left w-20">주소</div>
            <div class="float-left w-20">받으실분</div>
            <div class="float-left w-20">연락처</div>
            <div class="float-left w-20">수정</div>
        </div>
