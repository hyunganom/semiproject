<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <link rel = "stylesheet" type = "text/css" href = "/css/SANGMIN_footer.css">
...
<footer class="footer">
               ...
               <div class="btmfooter">
                   <div class="inner">
                       ...
                       <span class="footerlog"><img class="image" width="150px;" height="150px" src="./image/semilogo.png"></span>
                   </div> <!--//inner-->
               </div> <!--//btmfooter-->
           </footer> <!--//footer-->
