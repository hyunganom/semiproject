...
<footer class="footer">
               <div class="topfooter">
                   <div class="inner">
                       <ul class="sns1">
                           <li><a href="https://m.facebook.com/login/?locale=ko_KR" title="페이스북"><img src="${pageContext.request.contextPath}/image/facebook.icon.png" alt="페이스복"  width="30px" height="30px" alt="페이스북"></a></li>
                           <li><a href="https://www.instagram.com/_a_tiiiiiii/" title="인스타그램"><img src="${pageContext.request.contextPath}/image/insta.icon.png" alt="인스타그램" width="30px" height="30px" alt="인스타그램"></a></li>
                           <li><a href="https://open.kakao.com/o/gBPt13Ke" title="카카오톡"><img src="${pageContext.request.contextPath}/image/kakao.icon.png" alt="카카오톡" width="30px" height="30px" alt="카카오톡"></a></li>
               ...
               <div class="btmfooter">
                   <div class="inner">
                       ...
                       <span class="footerlog"><img class="image" width="200px;" height="150px" src="${pageContext.request.contextPath}/image/logo.png"></span>
                   </div> <!--//inner-->
               </div> <!--//btmfooter-->
           </footer> <!--//footer-->
